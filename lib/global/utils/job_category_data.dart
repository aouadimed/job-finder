class JobCategory {
  ...
  JobCategory({required this.category, required this.subcategories});
}

List<JobCategory> jobCategories = [
  JobCategory(category: 'Administrative', subcategories: [
  ...
  JobCategory(category: 'Agriculture and Natural Resources', subcategories: [
    'Agronomy',
    'Agronomist',
    'Crop Consultant',
    'Soil Scientist',
  ...
  JobCategory(category: 'Construction and Trades', subcategories: [
  ...
  JobCategory(category: 'Corporate Affairs', subcategories: [
    'Public Relations (PR)',
    'PR Specialist',
    'PR Manager',
    'PR Director',
  ...
  JobCategory(category: 'Creative and Media', subcategories: [
    'Advertising',
    'Account Executive',
  ...
  JobCategory(category: 'Education and Training', subcategories: [
  ...
  JobCategory(category: 'Engineering', subcategories: [
    'Civil Engineering',
    'Structural Engineer',
  ...
  JobCategory(category: 'Finance & Accounting', subcategories: [
    'Accounting',
    'Accountant',
    'Auditor',
    'Bookkeeper',
  ...
  JobCategory(category: 'Healthcare and Medical', subcategories: [
    'Nursing',
    'Registered Nurse',
    'Nurse Practitioner',
  ...
  JobCategory(category: 'Hospitality and Tourism', subcategories: [
    'Accommodation',
    'Hotel Manager',
    'Front Desk Agent',
    'Housekeeper',
  ...
  JobCategory(category: 'Human Resources and Recruiting', subcategories: [
  ...
  JobCategory(category: 'Information Technology', subcategories: [
  ...
  JobCategory(category: 'Legal and Law Enforcement', subcategories: [
    'Corporate Law',
    'Corporate Attorney',
  ...
  JobCategory(category: 'Manufacturing', subcategories: [
    'Production',
    'Production Manager',
  ...
  JobCategory(category: 'Sales & Marketing', subcategories: [
    'Brand Management',
    'Brand Manager',
    'Marketing Manager',
    'Product Manager',
  ...
  JobCategory(category: 'Science & Research', subcategories: [
    'Biotechnology',
    'Biochemist',
    'Biomedical engineer',
    'Biostatistician',
